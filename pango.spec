...
Source0  : https://download.gnome.org/sources/pango/1.48/pango-1.48.7.tar.xz
...
%prep
%setup -q -n pango-1.48.7
cd %{_builddir}/pango-1.48.7
pushd ..
cp -a pango-1.48.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1625763910
...
cp %{_builddir}/pango-1.48.7/COPYING %{buildroot}/usr/share/package-licenses/pango/bf50bac24e7ec325dbb09c6b6c4dcc88a7d79e8f
cp %{_builddir}/pango-1.48.7/subprojects/gi-docgen/LICENSES/Apache-2.0.txt %{buildroot}/usr/share/package-licenses/pango/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/pango-1.48.7/subprojects/gi-docgen/LICENSES/CC-BY-SA-3.0.txt %{buildroot}/usr/share/package-licenses/pango/fb41626a3005c2b6e14b8b3f5d9d0b19b5faaa51
cp %{_builddir}/pango-1.48.7/subprojects/gi-docgen/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/pango/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/pango-1.48.7/subprojects/gi-docgen/LICENSES/GPL-3.0-or-later.txt %{buildroot}/usr/share/package-licenses/pango/31a3d460bb3c7d98845187c716a30db81c44b615
cp %{_builddir}/pango-1.48.7/subprojects/gi-docgen/LICENSES/MIT.txt %{buildroot}/usr/share/package-licenses/pango/220906dfcc3d3b7f4e18cf8a22454c628ca0ea2e
cp %{_builddir}/pango-1.48.7/subprojects/gi-docgen/LICENSES/OFL-1.1.txt %{buildroot}/usr/share/package-licenses/pango/8b8a351a8476e37a2c4d398eb1e6c8403f487ea4
...
/usr/lib64/haswell/libpango-1.0.so.0.4800.7
/usr/lib64/haswell/libpangocairo-1.0.so.0
/usr/lib64/haswell/libpangocairo-1.0.so.0.4800.7
/usr/lib64/haswell/libpangoft2-1.0.so.0
/usr/lib64/haswell/libpangoft2-1.0.so.0.4800.7
/usr/lib64/haswell/libpangoxft-1.0.so.0
/usr/lib64/haswell/libpangoxft-1.0.so.0.4800.7
