...
Source0  : https://download.gnome.org/sources/pango/1.40/pango-1.40.10.tar.xz
...
%prep
%setup -q -n pango-1.40.10
pushd ..
cp -a pango-1.40.10 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1502866416
export AR=gcc-ar
...
%autogen --disable-static --enable-explicit-deps=yes  --with-included-modules=basic-fc --with-xft
...
%autogen --disable-static --enable-explicit-deps=yes  --with-included-modules=basic-fc --with-xft  --libdir=/usr/lib32 --build=i686-generic-linux-gnu --host=i686-generic-linux-gnu --target=i686-clr-linux-gnu
make V=1  %{?_smp_mflags}
popd
%install
export SOURCE_DATE_EPOCH=1502866416
...
/usr/lib64/libpango-1.0.so.0.4000.10
/usr/lib64/libpangocairo-1.0.so.0
/usr/lib64/libpangocairo-1.0.so.0.4000.10
/usr/lib64/libpangoft2-1.0.so.0
/usr/lib64/libpangoft2-1.0.so.0.4000.10
/usr/lib64/libpangoxft-1.0.so.0
/usr/lib64/libpangoxft-1.0.so.0.4000.10

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libpango-1.0.so.0
/usr/lib32/libpango-1.0.so.0.4000.10
/usr/lib32/libpangocairo-1.0.so.0
/usr/lib32/libpangocairo-1.0.so.0.4000.10
/usr/lib32/libpangoft2-1.0.so.0
/usr/lib32/libpangoft2-1.0.so.0.4000.10
/usr/lib32/libpangoxft-1.0.so.0
/usr/lib32/libpangoxft-1.0.so.0.4000.10
