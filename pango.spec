...
Source0  : https://download.gnome.org/sources/pango/1.40/pango-1.40.8.tar.xz
...
%prep
%setup -q -n pango-1.40.8
pushd ..
cp -a pango-1.40.8 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1502126719
export AR=gcc-ar
...
/usr/lib64/libpango-1.0.so.0.4000.8
/usr/lib64/libpangocairo-1.0.so.0
/usr/lib64/libpangocairo-1.0.so.0.4000.8
/usr/lib64/libpangoft2-1.0.so.0
/usr/lib64/libpangoft2-1.0.so.0.4000.8
/usr/lib64/libpangoxft-1.0.so.0
/usr/lib64/libpangoxft-1.0.so.0.4000.8

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libpango-1.0.so.0
/usr/lib32/libpango-1.0.so.0.4000.8
/usr/lib32/libpangocairo-1.0.so.0
/usr/lib32/libpangocairo-1.0.so.0.4000.8
/usr/lib32/libpangoft2-1.0.so.0
/usr/lib32/libpangoft2-1.0.so.0.4000.8
/usr/lib32/libpangoxft-1.0.so.0
/usr/lib32/libpangoxft-1.0.so.0.4000.8
