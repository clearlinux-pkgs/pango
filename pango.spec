...
Source0  : https://download.gnome.org/sources/pango/1.52/pango-1.52.0.tar.xz
...
%prep
%setup -q -n pango-1.52.0
cd %{_builddir}/pango-1.52.0
pushd ..
cp -a pango-1.52.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708992962
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libpango-1.0.so.0.5200.0
/V3/usr/lib64/libpangocairo-1.0.so.0.5200.0
/V3/usr/lib64/libpangoft2-1.0.so.0.5200.0
/V3/usr/lib64/libpangoxft-1.0.so.0.5200.0
/usr/lib64/libpango-1.0.so.0
/usr/lib64/libpango-1.0.so.0.5200.0
/usr/lib64/libpangocairo-1.0.so.0
/usr/lib64/libpangocairo-1.0.so.0.5200.0
/usr/lib64/libpangoft2-1.0.so.0
/usr/lib64/libpangoft2-1.0.so.0.5200.0
/usr/lib64/libpangoxft-1.0.so.0
/usr/lib64/libpangoxft-1.0.so.0.5200.0
