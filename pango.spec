...
Source0  : https://download.gnome.org/sources/pango/1.40/pango-1.40.7.tar.xz
...
%prep
%setup -q -n pango-1.40.7
pushd ..
cp -a pango-1.40.7 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1500368341
export AR=gcc-ar
...
/usr/lib64/libpango-1.0.so.0.4000.7
/usr/lib64/libpangocairo-1.0.so.0
/usr/lib64/libpangocairo-1.0.so.0.4000.7
/usr/lib64/libpangoft2-1.0.so.0
/usr/lib64/libpangoft2-1.0.so.0.4000.7
/usr/lib64/libpangoxft-1.0.so.0
/usr/lib64/libpangoxft-1.0.so.0.4000.7

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libpango-1.0.so.0
/usr/lib32/libpango-1.0.so.0.4000.7
/usr/lib32/libpangocairo-1.0.so.0
/usr/lib32/libpangocairo-1.0.so.0.4000.7
/usr/lib32/libpangoft2-1.0.so.0
/usr/lib32/libpangoft2-1.0.so.0.4000.7
/usr/lib32/libpangoxft-1.0.so.0
/usr/lib32/libpangoxft-1.0.so.0.4000.7
