...
Source0  : https://download.gnome.org/sources/pango/1.40/pango-1.40.14.tar.xz
...
%prep
%setup -q -n pango-1.40.14
pushd ..
cp -a pango-1.40.14 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1510976885
export AR=gcc-ar
...
/usr/lib32/libpango-1.0.so.0.4000.14
/usr/lib32/libpangocairo-1.0.so.0
/usr/lib32/libpangocairo-1.0.so.0.4000.14
/usr/lib32/libpangoft2-1.0.so.0
/usr/lib32/libpangoft2-1.0.so.0.4000.14
