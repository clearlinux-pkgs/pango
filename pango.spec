...
Source0  : https://download.gnome.org/sources/pango/1.42/pango-1.42.1.tar.xz
...
%prep
%setup -q -n pango-1.42.1
pushd ..
cp -a pango-1.42.1 build32
popd
pushd ..
cp -a pango-1.42.1 buildavx2
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1523109174
export AR=gcc-ar
...
/usr/lib64/haswell/libpango-1.0.so.0.4200.1
/usr/lib64/haswell/libpangocairo-1.0.so.0
/usr/lib64/haswell/libpangocairo-1.0.so.0.4200.1
/usr/lib64/haswell/libpangoft2-1.0.so.0
/usr/lib64/haswell/libpangoft2-1.0.so.0.4200.1
/usr/lib64/haswell/libpangoxft-1.0.so.0
/usr/lib64/haswell/libpangoxft-1.0.so.0.4200.1
/usr/lib64/libpango-1.0.so.0
/usr/lib64/libpango-1.0.so.0.4200.1
/usr/lib64/libpangocairo-1.0.so.0
/usr/lib64/libpangocairo-1.0.so.0.4200.1
/usr/lib64/libpangoft2-1.0.so.0
/usr/lib64/libpangoft2-1.0.so.0.4200.1
/usr/lib64/libpangoxft-1.0.so.0
/usr/lib64/libpangoxft-1.0.so.0.4200.1

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libpango-1.0.so.0
/usr/lib32/libpango-1.0.so.0.4200.1
/usr/lib32/libpangocairo-1.0.so.0
/usr/lib32/libpangocairo-1.0.so.0.4200.1
/usr/lib32/libpangoft2-1.0.so.0
/usr/lib32/libpangoft2-1.0.so.0.4200.1
/usr/lib32/libpangoxft-1.0.so.0
/usr/lib32/libpangoxft-1.0.so.0.4200.1
