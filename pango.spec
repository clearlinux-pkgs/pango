...
Version  : 1.51.2
Release  : 122
URL      : https://download.gnome.org/sources/pango/1.51/pango-1.51.2.tar.xz
Source0  : https://download.gnome.org/sources/pango/1.51/pango-1.51.2.tar.xz
...
%prep
%setup -q -n pango-1.51.2
cd %{_builddir}/pango-1.51.2
pushd ..
cp -a pango-1.51.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707751330
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libpango-1.0.so.0.5102.0
/V3/usr/lib64/libpangocairo-1.0.so.0.5102.0
/V3/usr/lib64/libpangoft2-1.0.so.0.5102.0
/V3/usr/lib64/libpangoxft-1.0.so.0.5102.0
/usr/lib64/libpango-1.0.so.0
/usr/lib64/libpango-1.0.so.0.5102.0
/usr/lib64/libpangocairo-1.0.so.0
/usr/lib64/libpangocairo-1.0.so.0.5102.0
/usr/lib64/libpangoft2-1.0.so.0
/usr/lib64/libpangoft2-1.0.so.0.5102.0
/usr/lib64/libpangoxft-1.0.so.0
/usr/lib64/libpangoxft-1.0.so.0.5102.0
